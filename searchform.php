<form action="<?php echo home_url( '/' ); ?>" method="get" class="form-inline flex-nowrap">
	...
	<button type="submit" class="<?php echo apply_filters('wpbs_search_btn_class','btn btn-primary');?>"><span class="search-label pr-1"><?php _e('Search', 'wpbs' ); ?></span><i class="fas fa-search"></i></button>
</form>