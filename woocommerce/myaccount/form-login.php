...
<?php if (get_option('woocommerce_enable_myaccount_registration') === 'no') : ?>
	<div class="row">
		<div class="col-md-8 col-lg-6 ml-auto mr-auto  mb-4">
			<?php do_action('woocommerce_before_customer_login_form'); ?>
			<h1 class="page-title"><?php esc_html_e('Login', 'woocommerce'); ?></h1>
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="custom-control custom-checkbox">
				...
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox custom-control-label" for="rememberme"><?php esc_html_e('Remember me', 'woocommerce'); ?></label>
			</p>
			
			<p class="woocommerce-LogIn d-flex justify-content-between">
				<button type="submit" class="woocommerce-Button button btn btn-primary" name="login" value="<?php esc_attr_e('Log in', 'woocommerce'); ?>"><?php esc_html_e('Log in', 'woocommerce'); ?></button>
