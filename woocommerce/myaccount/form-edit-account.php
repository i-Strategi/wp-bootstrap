...
<h1 class="page-title"><?php _e('Edit account', 'woocommerce') ; ?></h1>
...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action('woocommerce_edit_account_form_tag'); ?> >
	...
	<div class="row clearfix">
		...
		<p class="woocommerce-form-row woocommerce-form-row--wideform-row-wide col-12 form-group">
			<label for="account_display_name"><?php esc_html_e('Display name', 'woocommerce'); ?>&nbsp;<span class="required">*</span></label>
			<input type="text" class="woocommerce-Input woocommerce-Input--text input-text form-control" name="account_display_name" id="account_display_name" value="<?php echo esc_attr($user->display_name); ?>" /> <small><em><?php esc_html_e('This will be how your name will be displayed in the account section and in reviews', 'woocommerce'); ?></em></small>
		</p>

		<p class="woocommerce-form-row woocommerce-form-row--firstform-row-first col-6 form-group">
		...
		<p class="woocommerce-form-row woocommerce-form-row--lastform-row-last col-6 form-group">
		...
		<div class="col-12">
			<fieldset>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wideform-row-wide form-group">
