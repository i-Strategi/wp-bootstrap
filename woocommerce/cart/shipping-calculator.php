...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
	...
	<?php printf('<a href="#" class="shipping-calculator-button btn btn-primary">%s</a>', esc_html(! empty($button_text) ? $button_text : __('Calculate shipping', 'woocommerce'))); ?>

	<section class="shipping-calculator-form form-row" style="display:none;">

		<?php if (apply_filters('woocommerce_shipping_calculator_enable_country', true)) : ?>
			<p class="form-group col-12 mt-3" id="calc_shipping_country_field">
		...
		<?php if (apply_filters('woocommerce_shipping_calculator_enable_state', true)) : ?>
                ...
                if (is_array($states) && empty($states)) {
                    ...
                    ?>
					<p class="form-group col-12" id="calc_shipping_state_field">
		...
		<?php if (apply_filters('woocommerce_shipping_calculator_enable_postcode', true)) : ?>
			<p class="form-group col-4" id="calc_shipping_postcode_field">
				<input type="text" class="input-tex form-control" value="<?php echo esc_attr(WC()->customer->get_shipping_postcode()); ?>" placeholder="<?php esc_attr_e('Postcode / ZIP', 'woocommerce'); ?>" name="calc_shipping_postcode" id="calc_shipping_postcode" />
			</p>
		<?php endif; ?>

		<?php if (apply_filters('woocommerce_shipping_calculator_enable_city', true)) : ?>
			<p class="form-group col-8" id="calc_shipping_city_field">
		...
		<p class="form-group col-12"><button type="submit" name="calc_shipping" value="1" class="button btn btn-primary"><?php esc_html_e('Update', 'woocommerce'); ?></button></p>
